...
% ---------------------------------------------------------------- %
\anabilimdali{Matematik Ana Bilim Dalı}{Department of Mathematics}
\programi{}{}
...
\kisaltmalistesi{}
\sembollistesi{\input{simgeler-ve-kisaltmalar.tex}}
\ozet{\input{ozet.tex}}
\summary{\input{abstract.tex}}
\anahtarkelimeler{}
\keywords{}
\etikbeyan{\input{etik-beyan.tex}}
